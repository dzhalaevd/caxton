...
from formata.core._values import freeze_mapping, freeze_value
                    ...
                    TableSpec(
                        ...
                        columns=tuple(
                            ColumnSpec(
                                ...
                                semantic_type=_inspect_semantic_type(
                                    column.semantic_type,
                                ),
                                source=(
                                    None
                                    if column.source is None
                                    else _inspect_source(column.source)
                                ),
                                formula=(
                                    None
...
def _callable_identity(function: object) -> str:
    explicit = getattr(function, "__formata_id__", None)
