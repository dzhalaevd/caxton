...
from formata.api import sheet, spreadsheet, table
from formata.core.formatting import Alignment
from formata.core.models import Column, FieldRef, SpreadsheetDocument
...
def identifiers() -> st.SearchStrategy[str]:
    """Generate compact identifiers accepted by Formata models.
