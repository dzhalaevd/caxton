...
from caxton._spreadsheet.block_paths import iter_blocks_with_paths
from caxton._spreadsheet.compilation.formula_resolution import (
    FormulaCatalog,
    resolve_column,
    resolve_data_range,
)
from caxton._spreadsheet.layout import DocumentPlan, WorksheetPlan, plan_document
from caxton._spreadsheet.limits import SPREADSHEET_MAX_COLUMNS, SPREADSHEET_MAX_ROWS
from caxton._spreadsheet.preparation.aggregation import (
    PreparedColumn,
    PreparedTabularData,
    prepare_matrix,
    prepare_table,
)
from caxton._spreadsheet.preparation.semantic import SemanticRowEvaluator
from caxton._spreadsheet.shape import table_needs_preparation
...
_TITLE_FONT_SIZES = {1: 16.0, 2: 14.0, 3: 12.0}
RowT = TypeVar("RowT")


@dataclasses.dataclass(frozen=True, slots=True)
class _CompiledRows(Generic[RowT]):
    source: DataSource[RowT]
