...
from caxton._spreadsheet.preparation.aggregation.execution import (
...
from caxton._spreadsheet.preparation.aggregation.keys import (
    DimensionToken,
    GroupKey,
    TokenKey,
    key_token,
...
from caxton._spreadsheet.preparation.aggregation.models import (
    PreparedColumn,
    PreparedTabularData,
)
from caxton._spreadsheet.preparation.aggregation.tables import resolve_group_merges
...
def _order_matrix_keys(
    ...
    *,
    ...
    def visit(current: Sequence[MatrixKeyItem], level: int) -> None:
        buckets: dict[DimensionToken, MatrixKeyBucket] = {}
        for item in current:
