...
def require_name(value: object, label: str) -> None:
    ...
    Raises:
        CaxtonTypeError: If the value is not a string.
        CaxtonValueError: If the value is blank.
    """
...
def require_positive(value: object, label: str) -> None:
    ...
    Raises:
        CaxtonValueError: If the value is not positive.
    """
...
def require_non_negative(value: object, label: str) -> None:
    ...
    Raises:
        CaxtonValueError: If the value is negative.
    """
    number = _require_integer(value, label)
    if number < 0:
