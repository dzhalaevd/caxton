...
from caxton._spreadsheet.layout import DocumentPlan, plan_document
...
from caxton._xlsx.openpyxl.package import PivotDescriptor
...
class XlsxTemplateInspector:
    ...
    def inspect(self, template: TemplateSpecification) -> XlsxTemplateContext:
        ...
        try:
            ...
            workbook.close()
        from caxton._xlsx.openpyxl.package import (  # noqa: PLC0415
            inspect_pivots,
        )
