    ...
    return spreadsheet(
        sheet(
            ...
            table(
                rows,
                integer("id").title("ID"),
                text("emis", source="emis_code").title("EMIS"),
                text("comment").title("Comment"),
                text("incident", source="incident_number").title("Incident"),
                integer("days", source="days_on_base_price").title("Days"),
                text("owner", source=path("owner", "name")).title("Owner"),
                decimal("price").title("Price"),
                decimal("base_price").title("Base price"),
                decimal("delta", source=field("price") - field("base_price")).title(
                    "Delta"
                ),
                boolean("active").title("Active"),
                date("created_on").title("Created"),
            ),
        ),
    )
